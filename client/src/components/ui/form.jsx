...
/*
  Form System (react-hook-form wrapper)

  Purpose:
  Centralized structured form handling so every input behaves consistently:
  - label binding
  - validation errors
  - accessibility ids
  - descriptions
  ...
  Without this → every page implements forms differently → chaos.
*/
